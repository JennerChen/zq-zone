    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            ...
            <ProjectCard
              title="安捷秀"
              link="https://agileshot.vsochina.com"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              安捷秀影视项目管理工具，影视方向项目进度管理工具
            </ProjectCard>
            {/*<ProjectCard*/}
            {/*title="Tomb Raider"*/}
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <AboutDesc>
            毕业之后一直在天堂苏州, 深入研究 react全家桶中。
            日常作为程序员👨‍💻帮公司‍搬砖，闲暇时候研究下前端新技术，帮朋友写写项目。(⊙v⊙)嗯,
            除了代码还有什么?, 好吧, 我还是一个小市民,
            双休在家看看电影，玩玩游戏，搜搜哪有活动买便宜货。
            <br />
            <span style={{ fontSize: ".6em", fontStyle: "italic" }}>
              --javascript是世界最好的语言
            </span>
          </AboutDesc>
        </Inner>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          <Title>联系我</Title>
          <ContactText>
            📮 <a href="mailto:zhangqing332@live.com">zhangqing332@live.com</a>{" "}
          </ContactText>
        ...
        <Footer>&copy; Made Love By 💕 张庆 ❤️ .</Footer>
      </Content>
